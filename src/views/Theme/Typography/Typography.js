            ...
            <table className="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <span className="h1">h1. Example Heading</span>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <span className="h2">h2. Example Heading</span>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <span className="h3">h3. Example Heading</span>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <span className="h4">h4. Example Heading</span>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <span className="h5">h5. Example Heading</span>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <span className="h6">h6. Example Heading</span>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <div className="bd-example">
              <p className="h1">h1. Example Heading</p>
              <p className="h2">h2. Example Heading</p>
              <p className="h3">h3. Example Heading</p>
              <p className="h4">h4. Example Heading</p>
              <p className="h5">h5. Example Heading</p>
              <p className="h6">h6. Example Heading</p>
            </div>
          </div>
        </div>
        <div className="card">
